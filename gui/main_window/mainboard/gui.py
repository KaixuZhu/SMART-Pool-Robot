...
class Dashboard(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        ...
        entry_bg_1 = canvas.create_image(215.0, 81.0, image=canvas.entry_image_1)
        entry_1 = Entry(
            self,
            bd=0,
            bg="#EFEFEF",
        ...
        entry_1.place(x=155.0, y=30.0 + 2, width=120.0, height=0)
        ...
        canvas.create_text(
            ...
            text="电量",
            fill="#5E95FF",
            font=("Gen Jyuu Gothic P Bold", 14 * -1),
        )
        # Vacant Text
        canvas.create_text(
            264.0,
            ...
            text="87%",
            fill="#48b450",
            font=("Gen Jyuu Gothic P Bold", 48 * -1),
            justify="right",
        )
        canvas.entry_image_2 = PhotoImage(file=relative_to_assets("entry_2.png"))
        entry_bg_2 = canvas.create_image(465.0, 81.0, image=canvas.entry_image_2)
        entry_2 = Entry(
            self,
            bd=0,
            bg="#EFEFEF",
        ...
        entry_2.place(x=439.0, y=30.0 + 2, width=120.0, height=0)
        ...
        canvas.entry_image_4 = PhotoImage(file=relative_to_assets("icon_1.png"))
        entry_bg_4 = canvas.create_image(250.0, 50.0, image=canvas.entry_image_4)
        ...
        canvas.create_text(
            ...
            text="我的机器人"
                 "",
            fill="#5E95FF",
            font=("Gen Jyuu Gothic P Medium", 26 * -1),
        )
        ...
        canvas.create_text(
            ...
            text="已清洁",
            fill="#5E95FF",
            font=("Gen Jyuu Gothic Normal", 13 * -1),
        )
        ...
        canvas.image_image_2 = PhotoImage(file=relative_to_assets("your_robot.png"))
        image_2 = canvas.create_image(200.0, 310.0, image=canvas.image_image_2)

        fig1 = Figure(figsize=(2.2, 1.30), dpi=100)
        fig1.patch.set_facecolor("#eeefee")
        plot2 = fig1.add_subplot(111)
        plot2.pie([1, 7], [0.1, 0.1], startangle=-30, colors=("#6495ED", "#8A8A8A"))

        canvas1 = FigureCanvasTkAgg(fig1, self)
        canvas1.draw()
        canvas1.get_tk_widget().place(x=359, y=253)
